    ...
    <MainLayout>
      <div className="p-5">
        {!video || isVideoLoading ? (
          ...
          <>
            <div className="w-full h-auto border border-gray-400 bg-black max-h-[600px]">
              <ReactPlayer url={video.video} controls={true} width="100%" height="600px" volume={0.1} cla />
            </div>
