...
const RegisterForm = () => {
  ...
  return (
    <form action="" className="" onSubmit={handleSubmit(onSubmit)} role="reg-form">
      <AuthFormControl
      ...
      />
      <AuthFormControl
        register={register("name", validate(2, 35))}
        label="Channel name"
        id="name"
        type="text"
        error={errors.name}
      />
      <AuthFormControl
        register={register("password", validate(6, 35))}
        label="Password"
        id="password"
        type="password"
      ...
      <div className="">
        ...
        <div className="flex items-center justify-between mt-5">
          ...
          <button role="reg-submit-btn"
            className="text-white bg-lightBlue px-7 py-2 rounded-md transition-colors hover:bg-primaryBlue"
            type="submit"
